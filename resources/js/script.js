...
function displayAssets(){
		var json_url = "//subscription-assets.timeinc.com/prod/assets/themes/magazines/default/template-resources/js/selfpublishing/PE/this-week-issue-mobile/this-week-issue-mobile-v2.js",
...
function rearrange(x) {
	...
	var content = "#"+x;
	$(content).parent().prepend($(content));
...
$(document).ready(function(){
	...
	$("#starTracksDiv, #featureDiv, #greatIdeasDiv").click( function() {
		if($(this).children(".rtIcon").attr("src") == "resources/images/icn-arrow-pink-dwn.png"){
			$(this).children(".rtIcon").attr("src","resources/images/icn-arrow-pink-rgt.png");
			$(this).children(".rotateText").css("display","none");
			}
		else if($(this).children(".rtIcon").attr("src") == "resources/images/icn-arrow-pink-rgt.png"){
			$(this).children(".rtIcon").attr("src","resources/images/icn-arrow-pink-dwn.png");
			$(this).children(".rotateText").css("display","block");
...
function twitterPixels() {
	...
	*/
	...
	$("#twitterPixels").html('<iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMTwiS;ord=' + randomNumbers.standard + '?" width="1" height="1" frameborder="0" style="display:none"></iframe><iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMTwiU;ord=1;num=' + randomNumbers.unique + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
...
function facebookPixels() {
	...
	*/
	...
	$("#facebookPixels").html('<iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMFacS;ord' + randomNumbers.standard + '?" width="1" height="1" frameborder="0" style="display:none"></iframe><iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMFacU;ord=1;num=' + randomNumbers.unique + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
...
function pinterestPixels() {
	...
	*/
	...
	$("#pinterestPixels").html('<iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMPinS;ord=' + randomNumbers.standard + '?" width="1" height="1" frameborder="0" style="display:none"></iframe><iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMPinU;ord=1;num=' + randomNumbers.unique + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
...
function sneakPeekPixels() {
	...
	$("#sneakPeekPixels").html('<iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMSPS;ord=' + randomNumbers.standard + '?" width="1" height="1" frameborder="0" style="display:none"></iframe><iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMSPU;ord=1;num=' + randomNumbers.unique + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
...
function buyNowPixels() {
	...
	$("#buyNowPixels").html('<iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMBNS;ord=' + randomNumbers.standard + '?" width="1" height="1" frameborder="0" style="display:none"></iframe><iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMBNU;ord=1;num=' + randomNumbers.unique + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
...
function couponPixels() {
	...
	*/
	...
	$("#couponPixels").html('<iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMSavS;ord' + randomNumbers.standard + '?" width="1" height="1" frameborder="0" style="display:none"></iframe><iframe src="https://3980839.fls.doubleclick.net/activityi;src=3980839;type=peopl017;cat=peoMSavU;ord=1;num=' + randomNumbers.unique + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
